          ...
          <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
              <li className="nav-item align-items-center d-flex ml-5">
                <NavLink className="nav-link active bg-white px-4 py-1 shadow-sm" aria-current="page" to="/">
                  <span className="px-3 text-primary font-weight-bold">Login</span>
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link text-white font-weight-bold mx-4" to="/">
                  More
                </NavLink>
              </li>
              <li className="nav-item align-items-center d-flex">
                <NavLink
                  ...
                  aria-disabled="true"
                >
                    &nbsp;<b className="" style={{fontSize:"17px"}}>Cart</b>
      ...
      <nav class="navbar navbar-light bg-light shadow-sm">
        <div class="container">
          {Content.map((elem) => {
            ...
            return (
                <div className="my-3">
                  <div className="justify-content-center d-flex"><img src={image} className="img-fluid text-center" style={{width:"65px"}}></img></div>
                  <div className="justify-content-center d-flex mt-1"><h7 style={{fontSize:"14px"}}><b>{text}</b></h7></div>
                </div>
            );
          })}
        </div>
